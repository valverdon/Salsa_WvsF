...
TC_abAqG = tempcorr(temp.ab_12_AqG, T_ref, T_A);
TC_abM =  tempcorr(temp.ab_norM, T_ref, T_A);
...
%same for natural f
 ...
 prdData.ab_12_AqG = aT_b_AqG;
 prdData.ab_norM = aT_b_M;
% prdData.ts = tT_s;
...
%  prdData.E0 = E_0; 
  ...
  %idem 10°C
  TC10 = tempcorr(temp.tWwe_T10, T_ref, T_A);
  vT10 = v * TC10; 
 ...
 %idem 8°C
 TC8 = tempcorr(temp.tWwe_T8, T_ref, T_A);
  vT8 = v * TC8; 
