...
data.ab = 148;    units.ab = 'd';    label.ab = 'age at birth';             bibkey.ab = 'JoshkaUnpub';     
temp.ab= mean(tTireland(1:148,2)) ; units.temp.ab = 'K'; label.temp.ab = 'temperature vs time';
comment.ab = 'Ireland dataset, 0=fertilisation';%f =1
...
data.tsp_ire =(3.86-1)*365.25; % 
  units.tsp_ire = 'd';    label.tsp_ire = 'time since birth at puberty';  bibkey.tsp_ire = 'Hutchings1998'; 
...
% data.Lp_fra  = 63.5 ;   units.Lp_spa  = 'cm';  label.Lp_spa  = 'total length at puberty (grilse)'; bibkey.Lp_spa  = 'Hutchings1998';   
%   comment.Lp_spa = 'mean of French population';
data.Lsp_ire  = 61.8 ;   units.Lsp_ire  = 'cm';  label.Lsp_ire  = 'total length at puberty (grilse)'; bibkey.Lsp_ire  = 'Hutchings1998';   
