...
lowVal = 0.1;   % lower value of the profile interval, depends on the parameter
% lowVal=[0.4,0.025,0.8,10,1000];
upperVal = 50;  % upper value of the profile interval, depends on the parameter
% upperVal=[10,0.1,0.9999,15000,1000000];
dim = 5;         % increase for a smooth profile (optional)
