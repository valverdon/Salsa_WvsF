...
%%%%%%%%%%%%%%%%%%%%%%%%%
% data.ab_12_AqG = 96;    units.ab_12_AqG = 'd';    label.ab_12_AqG = 'age at first feeding';             bibkey.ab = 'Handeland2008';     
...
%%%%%%%%%%%%%%%%%%%%
%% Age at 1st spawning % in time since birth
...
data.asp_norNBP = (1.07+1)*365.25;   %=391
units.asp_norNBP = 'd';    label.asp_norNBP = 'age at puberty';             bibkey.asp_norNBP = 'Hindar2006';     
...
units.asp_norire = 'd';    label.asp_norire = 'age at puberty';             bibkey.asp_norire = 'Hindar2006';     
comment.asp_norire = 'farmed strain (time since birth) ; table3';
temp.asp_norire = C2K(10);  units.temp.asp_norire = 'K'; label.temp.asp_norire = 'temperature'; label.temp.comment.asp_norire = 'T° : rough guess - highly variable temperature throughout life(2+1.93-1)*365.25';%natural T°, natural f.
...
data.Ri=1063/0.3; units.Ri = '-/d';    label.Ri = 'maximum number of eggs';             bibkey.Ri = 'Fleming1996b';
...
weights.asp_norNBP=weights.asp_norNBP/2;
weights.asp_norire=weights.asp_norire/2; % 2 age at puberty zero-V data
