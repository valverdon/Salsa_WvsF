...
data.tsp_nor = (5.71-1)*365.25; %1355;  
  units.tsp_nor = 'd';    label.tsp_nor = 'time since birth at spawning';  bibkey.tsp_nor = 'Hutchings1998'; 
  temp.tsp_nor = C2K(10);  units.temp.tsp_nor = 'K'; label.temp.tsp_nor = 'temperature'; 
  comment.tsp_nor = 'Mean of Norwegian populations; temperature: rough guess - highly variable temperature throughout life ((river age+sea age+1(fertilization to birth as in Hutchings 1998))-1(we remove it)-1(puberty occurs~1year before spawning)) , Table2';
...
data.tsp_norI =(1.68+1.22)*365.25; % 694;  
  units.tsp_norI = 'd';    label.tsp_norI = 'time since birth at spawning';  bibkey.tsp_norI = 'Hindar2006'; 
  temp.tsp_norI = C2K(10);  units.temp.tsp_norI = 'K'; label.temp.tsp_norI = 'temperature'; 
  comment.tsp_norI = 'Mean of Imsa river (Norway); temperature: rough guess - highly variable temperature throughout life, Table3';
...
data.Lsp_norSf  = 52.7 ;   units.Lsp_norSf  = 'cm';  label.Lsp_norSf  = 'postorbital-hypural length at 1st spawning'; bibkey.Lsp_norSf  = 'Fleming1996b';   comment.Lsp_norSf = 'mean females at spawning, river Imsa (Canada) table 1';
data.Lsp_norSm  = 47.7 ;   units.Lsp_norSm  = 'cm';  label.Lsp_norSm  = 'postorbital-hypural length at 1st spawning'; bibkey.Lsp_norSm  = 'Fleming1996b';   comment.Lsp_norSm = 'mean males at spawning, river Imsa (Canada) table 1';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
data.Wwsp_norf = 2856;   units.Wwsp_norf = 'g';   label.Wwsp_norf = 'wet weight at puberty';   bibkey.Wwsp_norf = 'Fleming1996b';   comment.Wwsp_nor_norf = 'Imsa river(Norway), mean of females at spawning, Table 1';
data.Wwsp_norm = 1920;   units.Wwsp_norm = 'g';   label.Wwsp_norm = 'wet weight at puberty';   bibkey.Wwsp_norm = 'Fleming1996b';   comment.Wwsp_nor_norm = 'Imsa river(Norway), mean of males at spawning, Table 1';
...
data.Ri_nor  = 9576;   units.Ri_nor  = '#/d'; label.Ri_nor  = 'maximum egg number';     bibkey.Ri_nor  = 'Fleming1996';   
...
weights.tsp_nor = weights.tsp_nor/2;
...
weights.tsp_norI = weights.tsp_norI/2;
...
weights.tL_nor4 = weights.tL_nor4/2/4;
weights.tL_nor5 = weights.tL_nor5/2/4;
weights.tL_nor7 = weights.tL_nor7/2/4;
weights.tL_nor57 = weights.tL_nor57/2/4;
