function [par, metaPar, txtPar] = pars_init_Salmo_salar_farm_Ch(metaData)
...
par.T_A = 7500;       free.T_A   = 1;   units.T_A = 'K';          label.T_A = 'Arrhenius temperature'; %on va l'avoir
...
par.E_Hj = par.E_Hb*5/4; free.E_Hj  = 1;   units.E_Hj = 'J';         label.E_Hj = 'maturity at metam'; 
...
par.f_nat = 0.7;          free.f_nat     = 1;   units.f_nat = '-';            label.f_nat = 'scaled functional response for 0-var data, when reared in natural condition (not ad lib)'; 
par.f_tWeVe_tWeYe = par.f;  free.f_tWeVe_tWeYe = 0; units.f_tWeVe_tWeYe = '-';  label.f_tWeVe_tWeYe = 'scaled functional response for embryo growth';
