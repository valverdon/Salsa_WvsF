...
data.tp_gbr = 1308;    units.tp_gbr = 'd';    label.tp_gbr = 'time since birth at puberty';  bibkey.tp_gbr = 'Hutchings1998'; 
  temp.tp_gbr = C2K(10);  units.temp.tp_gbr = 'K'; label.temp.tp_gbr = 'temperature';
  comment.tp_gbr = 'Mean of brittish populations; temperature: rough guess - highly variable temperature throughout life ';% fo  hutchings : (1(fertilization->birth)+river age+sea age -1)
 data.tp_ice = 1658;    units.tp_ice = 'd';    label.tp_ice = 'time since birth at puberty';  bibkey.tp_ice = 'Hutchings1998'; 
 ...
 data.tp_nor = 1721;    units.tp_nor = 'd';    label.tp_nor = 'time since birth at puberty';  bibkey.tp_nor = 'Hutchings1998'; 
 ...
 data.tp_fraspa = 1045;    units.tp_fraspa = 'd';    label.tp_fraspa = 'time since birth at puberty';  bibkey.tp_fraspa = 'Hutchings1998'; 
 ...
 data.tp_ire = 1125;    units.tp_ire = 'd';    label.tp_ire = 'time since birth at puberty';  bibkey.tp_ire = 'Hutchings1998'; 
  ...
  %f= natural
   ...
   data.tp_canm = 1129;    units.tp_canm = 'd';    label.tp_canm = 'time since birth at first maturity';  bibkey.tp_canm = 'Bailey1980'; 
  temp.tp_canm = C2K(10);  units.temp.tp_canm = 'K'; label.temp.tp_canm = 'temperature'; 
  comment.tp_canm = 'mean of 4 New brunswick rivers(Canada); temperature: rough guess - highly variable temperature throughout life;  scalimetry (smolt age + sea age-1) *365.25';
 data.tp_canf = 1134;    units.tp_canf = 'd';    label.tp_canf = 'time since birth at first maturity';  bibkey.tp_canf = 'Bailey1980'; 
  temp.tp_canf = C2K(10);  units.temp.tp_canf = 'K'; label.temp.tp_canf = 'temperature'; 
  comment.tp_canf = 'mean of 4 New brunswick rivers(Canada); temperature: rough guess - highly variable temperature throughout life;  scalimetry (smolt age + sea age-1) *365.25';
    %f= natural
...
data.tp_rus = 1366;    units.tp_rus = 'd';    label.tp_rus = 'time since birth at maturity';  bibkey.tp_rus = 'Kazakov1981'; 
 ...
 data.tp_ire2 = 745;    units.tp_ire2 = 'd';    label.tp_ire2 = 'time since birth at spawning';  bibkey.tp_ire2 = 'Hindar2006'; 
  temp.tp_ire2 = C2K(10);  units.temp.tp_ire2 = 'K'; label.temp.tp_ire2 = 'temperature'; 
  comment.tp_ire2 = 'Mean of Burrishoole river (Norway); temperature: rough guess - highly variable temperature throughout life(2+1.04-1)*365.25';
  %f= natural
...
data.tL_norA4 = [ ... % time since emergence (d), fork length (cm)
56	4.7
232	5.4
360	6.4];
units.tL_norA4   = {'d', 'cm'};  label.tL_norA4 = {'time since birth', 'total length'};  
temp.tL_norA4    = C2K(4);  units.temp.tL_norA4 = 'K'; label.temp.tL_norA4 = 'temperature'; comment.temp.tL_norA4 = 'T=7.9 for t=0-56';
bibkey.tL_norA4 = 'Imsland2016'; comment.tL_norA4 = 'Ardal River (Norway)';

data.tL_norA5 = [ ... % time since emergence (d), fork length (cm)
56	4.7
232	5.8
360	7.1];
units.tL_norA5   = {'d', 'cm'};  label.tL_norA5 = {'time since birth', 'total length'};  
temp.tL_norA5    = C2K(5.5);  units.temp.tL_norA5 = 'K'; label.temp.tL_norA5 = 'temperature'; comment.temp.tL_norA5 = 'T=7.9 for t=0-56';
bibkey.tL_norA5 = 'Imsland2016'; comment.tL_norA5 = 'Ardal River (Norway)';

data.tL_norA7 = [ ... % time since emergence (d), fork length (cm)
56	4.7
232	6.4
360	9];
units.tL_norA7   = {'d', 'cm'};  label.tL_norA7 = {'time since birth', 'total length'};  
temp.tL_norA7    = C2K(7);  units.temp.tL_norA7 = 'K'; label.temp.tL_norA = 'temperature'; comment.temp.tL_norA7 = 'T=7.9 for t=0-56';
bibkey.tL_norA7 = 'Imsland2016'; comment.tL_norA7 = 'Ardal River (Norway)';

data.tL_norA57 = [ ... % time since emergence (d), fork length (cm)
56	4.7
232	7.6
360	8.1];
units.tL_norA57   = {'d', 'cm'};  label.tL_norA57 = {'time since birth', 'total length'};  
temp.tL_norA57    = C2K(5.7);  units.temp.tL_norA57 = 'K'; label.temp.tL_norA57 = 'temperature'; comment.temp.tL_norA57 = 'Simulated natural temperature, mean = 5.7, min = 2.4, max=11.5; start at 11.5, then 2.5�C at t=232, then rises';
bibkey.tL_norA57 = 'Imsland2016'; comment.tL_norA57 = 'Ardal River (Norway)';

data.tL_norSt4 = [ ... % time since emergence (d), fork length (cm)
45	4.8
221	5.6
349	6.4];
units.tL_norSt4   = {'d', 'cm'};  label.tL_norSt4 = {'time since birth', 'total length'};  
temp.tL_norSt4    = C2K(4);  units.temp.tL_norSt4 = 'K'; label.temp.tL_norSt4 = 'temperature'; comment.temp.tL_norSt4 = 'T=7.9 for t=0-56';
bibkey.tL_norSt4 = 'Imsland2016'; comment.tL_norSt4 = 'Stryn River (Norway)';

data.tL_norSt5 = [ ... % time since emergence (d), fork length (cm)
45	4.8
221	6.7
349	8.4];
units.tL_norSt5   = {'d', 'cm'};  label.tL_norSt5 = {'time since birth', 'total length'};  
temp.tL_norSt5    = C2K(5.5);  units.temp.tL_norSt5 = 'K'; label.temp.tL_norSt5 = 'temperature'; comment.temp.tL_norSt5 = 'T=7.9 for t=0-56';
bibkey.tL_norSt5 = 'Imsland2016'; comment.tL_norSt5 = 'Stryn River (Norway)';

data.tL_norSt7 = [ ... % time since emergence (d), fork length (cm)
45	4.8
221	6.9
349	10.3];
units.tL_norSt7   = {'d', 'cm'};  label.tL_norSt7 = {'time since birth', 'total length'};  
temp.tL_norSt7    = C2K(7);  units.temp.tL_norSt7 = 'K'; label.temp.tL_norSt7 = 'temperature'; comment.temp.tL_norSt7 = 'T=7.9 for t=0-56';
bibkey.tL_norSt7 = 'Imsland2016'; comment.tL_norSt7 = 'Stryn River (Norway)';

data.tL_norSt57 = [ ... % time since emergence (d), fork length (cm)
45	4.8
221	7.7
349	8.8];
units.tL_norSt57   = {'d', 'cm'};  label.tL_norSt57 = {'time since birth', 'total length'};  
temp.tL_norSt57    = C2K(5.7);  units.temp.tL_norSt57 = 'K'; label.temp.tL_norSt57 = 'temperature'; comment.temp.tL_norSt57 = 'Simulated natural temperature, mean = 5.7, min = 2.4, max=11.5; start at 11.5, then 2.5�C at t=232, then rises';
bibkey.tL_norSt57 = 'Imsland2016'; comment.tL_norSt57 = 'Stryn River (Norway)';
