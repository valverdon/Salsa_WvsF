...
pet = {'Salmo_salar_wild','Salmo_salar_farm'};  % replace my_pet, with your species name
...
lowVal = [0.2 0.2];   % lower value of the profile interval, depends on the parameter
upperVal = [0.99 0.99];  % upper value of the profile interval, depends on the parameter
...
nbTrials = 2;   % number of data sets (can be changed)
