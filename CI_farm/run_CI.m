...
%
tic
% for parametre in pProfile
    
%     if stepCI == 0 || stepCI == 2
%         fprintf('\n Step 2. Profile for parameter %s \n\n', parametre);
%         [lf_profile, pars_profile] = get_profile(parametre,lowVal,upperVal,dim,nCont);
